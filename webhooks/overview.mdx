---
title: "Webhooks"
description: "Receive real-time HTTP notifications whenever Roki publishes or updates an article."
---
...
| `article_type` | string | Article shape selected by Roki when planning the post — one of `Guide - Howto`, `Guide - Explainer`, `Comparison`, or `List - Roundup`. Useful for routing to different downstream templates. |
...
<Steps>
  <Step title="Endpoint URL">
    The full HTTPS URL Roki should POST to.
  </Step>
  <Step title="Events">
