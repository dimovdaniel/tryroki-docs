...
description: "Send Roki article events to Pabbly Connect and automate workflows — unlimited operations on all plans."
---
...
<Steps>
  <Step title="Create a new workflow">
    Log in to **pabbly.com/connect** and click **Create Workflow**. Give it a name (e.g. _Roki → Sheets_) and click **Create**.
  </Step>
